-- ============================================================================
-- FULL SCHEMA CHECK - SAFE VERSION (CREATE/UPDATE IF NOT EXISTS)
-- ============================================================================
-- Production-safe schema definition for entire CRM system
-- This version is more defensive and handles existing tables gracefully
...
SELECT add_column_if_not_exists('accounts', 'ownerId', 'UUID NOT NULL');
...
-- ============================================================================
-- TEAMS, SUPPLIERS, AND OTHER TABLES
-- ============================================================================
...
-- COMPLETION
-- ============================================================================
SELECT '✅ Full schema check completed successfully - all tables and columns are now in place' as status;
